...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.apple = pygame.image.load("D:/snakegame_materials/apple.jpg").convert()
...
class Snake:
    def __init__(self, parent_screen, length, length1):
        self.parent_screen = parent_screen
        self.direction = 'down'
        self.snake = pygame.image.load("D:/snakegame_materials/block1.png").convert()

        self.length = length
        self.block_x = [200] * length
        self.block_y = [size] * length
        
        self.block_x1 = [1040] * length1

        self.snake1 = pygame.image.load("D:/snakegame_materials/block.jpg").convert()
...
class Game:
    ...
    def play_background_music(self):
        pygame.mixer.music.load("D:/snakegame_materials/bg_music.mp3")
    ...
    def level(self):
        ...
        if self.snake.length1 > 20 and self.snake.lenght1 <= 30:
    ...
    def display_score(self):
        ...
        self.score = font.render(f"Yellow Snake {self.snake.length}", True, (255,255,255))
    ...
    def show_game_over(self):
        ...
        line1 = font.render(f"Yellow Snake {self.snake.length}", True, (255,255,255))
        self.surface.blit(line1, (525,200))
        line2 = font.render("To play again hit enter, to exit pres Escape", True, (255,255,255))
        self.surface.blit(line2, (400,400))
        line3 = font.render(f"Blue Snake {self.snake.length1}", True, (255,255,255))
        self.surface.blit(line3, (530,250))
        pygame.display.flip()
    ...
    def reset(self):
        self.snake = Snake(self.surface, length=1, length1=1)
        self.apple = Apple(self.surface)

    def Time(self):
        self.t = time.sleep(0.2)
    ...
    def run(self):
        ...
        font2 = pygame.font.SysFont('Agency fb', 24)
        ...
        while howtoloop:
            ...
            self.surface.blit(h1, (30, 20))
            self.surface.blit(h2, (30, 50))
            self.surface.blit(h3, (30, 80))
            self.surface.blit(h4, (30, 110))
            self.surface.blit(h5, (30, 140))
            self.surface.blit(h6, (30, 170))
